# Apple.com Web Design Reference (Archived)

> **Not JoeyPet UI source of truth.** This file preserves the previous root `Design.md` content: a design-token analysis of **Apple marketing websites** (apple.com product tiles, Store, Environment, etc.). Use it only for landing-page or marketing inspiration.
>
> **JoeyPet application UI** is governed by Stitch (JoeyPet project) and [`Design.md`](../../Design.md) at the repository root — not this file.
